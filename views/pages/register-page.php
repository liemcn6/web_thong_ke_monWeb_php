...
<body>
  <div class="vh-100 bg-light d-flex align-items-center">
    <div class="mx-auto shadow-sm rounded login">
      <h3 class="mb-4 text-center login-title">Đăng ký</h3>
      <form action="register" class="login-form needs-validation" id="login-form" method="POST" novalidate>
        ...
        <button class="btn custom-btn-purple w-100 py-2 mt-3" type="submit">Đăng ký</button>
      </form>

      <!-- separator -->
      <div class="separator my-3 d-flex justify-content-center align-items-center text-muted">
        <hr class="w-25" />
        <span class="mx-3">Hoặc đăng ký với</span>
        <hr class="w-25" />
      </div>
      ...
      <div class="register-now mt-4 text-center">
        ...
        <a href="" class="fw-bold text-decoration-none text-black">Đăng nhập</a>
      </div>
    </div>
  </div>
